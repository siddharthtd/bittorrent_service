...
con=sqlite3.connect(r'C:\Users\Deepak\PycharmProjects\bittorrent_service\Testfiles\serverdb\server.db')
cursor= con.cursor()
...
def addvalues(fileprop):
    cursor.execute("INSERT INTO  filedetails(filename,filepos,filesize) VALUES (?, ?, ?)",[fileprop['name'],fileprop['path'],fileprop['size']])
